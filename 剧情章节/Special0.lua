...
function SpecialZero(msg)
    ...
    elseif (Option == 1) then
        ...
        if (Choice == 1) then
            ...
            if (ChoiceIndex > 4) then OptionNormalInit(msg, 7) end
        ...
        elseif (Choice == 3) then
            ...
            ChoiceIndex = ChoiceIndex + 1
            setUserConf(msg.fromQQ, "ChoiceIndex", ChoiceIndex)
            if (ChoiceIndex > 3) then OptionNormalInit(msg, 7) end
        end
    elseif (Option == 2) then
        ...
        if (Choice == 1) then
            ...
            ChoiceIndex = ChoiceIndex + 1
            setUserConf(msg.fromQQ, "ChoiceIndex", ChoiceIndex)
            if (ChoiceIndex > 5) then OptionNormalInit(msg, 18) end
        elseif (Choice == 2) then
            if (favor < 2000) then
                return "您的好感度不足哦~为" .. favor
            end
            ...
            ChoiceIndex = ChoiceIndex + 1
            setUserConf(msg.fromQQ, "ChoiceIndex", ChoiceIndex)
            if (ChoiceIndex > 4) then OptionNormalInit(msg, 18) end
        elseif (Choice == 3) then
            -- 进入本选择则不可跳转
    ...
    elseif (Option == 4) then
        ...
        if (Choice == 1) then
            ...
            if (ChoiceIndex == 2) then
                content = Special0[MainIndex][ChoiceIndex][getUserConf(
                              msg.fromQQ, "Special0Option3", 1)]
            else
                content = Special0[MainIndex][ChoiceIndex]
            end
            ChoiceIndex = ChoiceIndex + 1
