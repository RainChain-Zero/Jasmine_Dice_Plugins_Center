...
function SpecialZero(msg)
    local MainIndex, Option, Choice, ChoiceIndex, favor =
        GetUserConf(msg.fromQQ, {"MainIndex", "Option", "Choice", "ChoiceIndex", "好感度"}, {1, 0, 0, 1, 0})
    ...
    elseif (Option == 3) then
        if (Choice == 0) then
            ...
            -- 记录下一个跳转选项
            SetUserConf(msg.fromQQ, {"NextOption","Special0Option3"}, {4,Choice})
    ...
    elseif (Option == 4) then
        ...
        if (Choice == 1) then
            ...
            if (ChoiceIndex > 6) then
                ...
                SetUserConf(msg.fromQQ, {"Special0Flag","isSpecial0Read"}, {1,1})
                Init(msg)
            end
        elseif (Choice == 2) then
            MainIndex = 26
