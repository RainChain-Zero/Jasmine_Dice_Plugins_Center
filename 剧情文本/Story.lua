...
Special0=
{
    ...
    [26]=
    {
        ...
        "{FormFeed}{FormFeed}".."“那...好吧”女孩的声音听起来有点落寞，这表示她其实挺想看看你写的是什么。\f"..
        "{FormFeed}{FormFeed}".."氛围顿时有点凝固，你不知道该说些什么，但好在手机还在持续播放着跨年节目，并不是特别的尴尬。",
        [2]="“那...能把它们烧了吗？”女孩突然提出了奇怪的请求。\f"..
        "{FormFeed}{FormFeed}".."“烧了？为什么”这听起来有些奇怪。",
        [3]="“嗯...这样或许愿望就能实现。”\f"..
        "{FormFeed}{FormFeed}".."虽然不知道为什么会这样，但你觉得这样也挺好的。",
...
Story1=
{
    ...
    [6]=
    {
        [1]="虽然不太可能，出于某些原因，你还是不能太放心，还是在大厅里坐下来检查起药品。\f".."{FormFeed}{FormFeed}".."手中的药品一件件经自己过目，没有任何问题，直到看到倒数第二件药品，你皱起了眉头。",
        [2]="这个名字……虽然对得上，但在自己的印象里似乎不是安神的药物。\f".."{FormFeed}{FormFeed}".."嘶，视线有些模糊了，你揉揉自己的眼睛，模糊的视线中字却发生了改变，就一两笔的区别，呃……自己原来累到这种程度了吗。",
    ...
    [16]=
    {
        [1]="来到灶台前，这些锅碗早已被洗得干干净净，这得归功于茉莉洗得好还是不做饭呢……你随手拿起一个碗，翻看起来。\f".."{FormFeed}{FormFeed}".."这碗和新的一样，该说茉莉洗得很干净吗，连一点污垢也看不到，还是说没怎么用过。",
    ...
    [19]=
    {
        ...
        .."{FormFeed}{FormFeed}".."你的心绪又回到了那个雨夜，自己撑着雨伞……是的，茉莉是自己捡来的，虽然有些扯淡，但对你来说却是记忆犹新的真实。她失忆了，茉莉这个名字是她昏倒是嘴里的呢喃，你也就这么叫她了。",
    ...
    [26]="“打开看看就知道了”\f你带着怀疑的心态将盒子打开，里面是一件……服务员西装……是的，就是茉莉工作的那一套，不过她的是裙子款式。",
